...
import { Module, Track } from "../types/types";
 ...
 */
const ModulesNav = ({ module, track }: ModulesNavProps) => {
  return (
    <ModulesNavContainer>
      <ModuleTitle>
        <h4>
...
interface ModuleListItemContentProps {
  isActive: boolean;
}

const ModuleListItemContent = styled.div(
  (props: ModuleListItemContentProps) => ({
